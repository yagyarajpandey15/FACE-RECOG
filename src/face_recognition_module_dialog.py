...
class FaceRecognitionSystem:
    ...
    def start_recognition(self, frame_callback=None):
        ...
        while True:
            ...
            cv2.putText(frame, "Press 'm' to mark attendance", (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
            cv2.putText(frame, "Press 'r' to register a face", (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
            ...
            if key == ord('q'):
                ...
                cv2.putText(frame, "PAUSED - Enter name in dialog", (10, 80), 
                ...
                cv2.putText(frame, "PAUSED - Registering new face", (10, 80), 
                            cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                cv2.imshow('Face Detection', frame)
